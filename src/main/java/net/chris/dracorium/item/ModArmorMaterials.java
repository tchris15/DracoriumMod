...
public enum ModArmorMaterials implements ArmorMaterial {
    Dracorium("dracorium", 40, new int[] { 3, 8, 6, 3 }, 20,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.5f, 0.2f, () -> Ingredient.ofItems(ModItems.DracoriumIngot));
    ...
    public String getName() {
        return DracoriumMod.MOD_ID + ":" + this.name;
    }
